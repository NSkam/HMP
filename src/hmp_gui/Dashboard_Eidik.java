...
public class Dashboard_Eidik extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Dashboard_eidik
     */
    public Dashboard_Eidik() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashboard_Eidik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dashboard_Eidik().setVisible(true);
            }
        });
    }
